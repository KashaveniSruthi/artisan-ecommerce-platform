...
const Collection = () => {
  ...
  return (
    <div className='flex flex-col sm:flex-row sm:gap-10 pt-10 '>
      {/* filter options*/}
      <div className='min-w-60'>
      <p onClick={()=>setShowFilter(!showFilter)} className='my-2 text-xl flex items-center cursor-pointer gap-2'> FILTERS
        <img className={`h-3 sm:hidden transform transition-transform duration-300 ${showFilter ? 'rotate-180' : 'rotate-0'}`} src={assets.dropdown} alt="dropdown icon" /></p>
        ...
        <div className={`border border-gray-300 pl-5 py-3 my-5 ${showFilter? '':'hidden'} sm:block`}>
          ...
          <p className='flex gap-2'>
            ...
            <p className='flex gap-2'>
              <input className='w-3' type='checkbox' value={'Pancha'} onChange={toggleSubCategory}/>Pancha
            </p>
            <p className='flex gap-2'>
              <input className='w-3' type='checkbox' value={'Winterwear'} onChange={toggleSubCategory}/>Winterwear
            </p>
            <p className='flex gap-2'>
              <input className='w-3' type='checkbox' value={'kurta'} onChange={toggleSubCategory}/>Kurtas
            </p>
            <p className='flex gap-2'>
            ...
            <p className='flex gap-2'>
              <input className='w-3' type='checkbox' value={'Crafts'} onChange={toggleSubCategory}/>Crafts
            </p>
          </div>
        </div>
  </div>
